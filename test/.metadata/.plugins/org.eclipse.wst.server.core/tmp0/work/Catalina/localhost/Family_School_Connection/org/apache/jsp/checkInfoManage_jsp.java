 ...
 * Generated at: 2017-10-11 08:55:02 UTC
...
public final class checkInfoManage_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\tcheckId:$('#s_checkId').val()\r\n");
      out.write("\t\t})\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\tstrIds.push(selectedRows[i].checkId);\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\tif(r){\r\n");
      out.write("\t\t\t\t$.post(\"checkDelete\",{delIds:ids},function(result){\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction openCheckAddDialog(){\r\n");
      out.write("\t\t\t$(\"#dlg\").dialog(\"open\").dialog(\"setTitle\",\"添加考勤情况信息\");\r\n");
      out.write("\t\t\turl=\"checkSave\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction openCheckModifyDialog(){\r\n");
      out.write("\t\t\tvar selectedRows=$(\"#dg\").datagrid('getSelections');\r\n");
      ...
      out.write("\t\t\turl=\"checkSave?checkId=\"+row.checkId;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction closeCheckDialog(){\r\n");
      out.write("\t\t\t$(\"#dlg\").dialog(\"close\");\r\n");
      out.write("\t\t\tresetValue();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction resetValue(){\r\n");
      out.write("\t\t\t$(\"#checkId\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#stuName\").val(\"\");\r\n");
      out.write("\t\t\t$(\"#checkDesc\").val(\"\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\tfunction saveCheck(){\r\n");
      ...
      out.write("\t pagination=\"true\" rownumbers=\"true\" url=\"checkList\" fit=\"true\" toolbar=\"#tb\">\r\n");
      out.write("\t\t<thead>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th field=\"cb\" checkbox=\"true\"></th>\r\n");
      out.write("\t\t\t\t<th field=\"checkId\" width=\"50\">编号</th>\r\n");
      out.write("\t\t\t\t<th field=\"stuName\" width=\"100\">学生姓名</th>\r\n");
      out.write("\t\t\t\t<th field=\"checkDesc\" width=\"250\">考勤情况</th>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</thead>\r\n");
      out.write("\t</table>\r\n");
      out.write("\t\r\n");
      out.write("\t<div id=\"tb\">\r\n");
      out.write("\t\t<div>\r\n");
      out.write("\t\t\t<a href=\"javascript:openCheckAddDialog()\" class=\"easyui-linkbutton\" iconCls=\"icon-add\" plain=\"true\">添加</a>\r\n");
      out.write("\t\t\t<a href=\"javascript:openCheckModifyDialog()\" class=\"easyui-linkbutton\" iconCls=\"icon-edit\" plain=\"true\">修改</a>\r\n");
      out.write("\t\t\t<a href=\"javascript:deleteCheck()\" class=\"easyui-linkbutton\" iconCls=\"icon-remove\" plain=\"true\">删除</a>\t\t\t\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t\t<div>&nbsp;学号:&nbsp;<input type=\"text\" name=\"s_checkId\" id=\"s_checkId\">\t\t\t<a href=\"javascript:searchCheck()\" class=\"easyui-linkbutton\" iconCls=\"icon-search\" plain=\"true\">搜索</a>\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t<td><input type=\"text\" name=\"checkDesc\" id=\"checkDesc\" class=\"easyui-validatebox\" required=\"true\"/></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t    </table>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t<a href=\"javascript:saveCheck()\" class=\"easyui-linkbutton\" iconCls=\"icon-ok\">保存</a>\r\n");
      out.write("\t\t<a href=\"javascript:closeCheckDialog()\" class=\"easyui-linkbutton\" iconCls=\"icon-cancel\">关闭</a>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
